  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        ...
        <a
          href="/signup"
          className="mt-12 px-8 py-4 bg-[rgb(0,251,205)] text-black font-semibold rounded-full text-lg hover:bg-[rgb(0,251,205)]/90 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[rgb(0,251,205)]/25 inline-block cursor-pointer"
        >
          Get Started
        </a>
      </div>
